...
* Mac Users: You can drag this to your standard Applications folder, or leave it on your Desktop/external drive.

------------------------------------------------------
STEP 2: The First Launch
------------------------------------------------------
Double-click the application to open it. (Note: Because this is an independent tool, Windows Defender or macOS Gatekeeper may ask you to confirm you want to run an "unrecognized" app. Simply click "More Info" -> "Run Anyway" on Windows, or Right-Click -> "Open" on Mac).
...
2. Documents Mode (The "Easy Access" Method)
   ...
   ⚠️ THE CLOUD SYNC TRAP: Do NOT use this option if your Documents folder is being actively backed up by iCloud Drive, OneDrive, or Dropbox. Running a live database inside a syncing folder will cause file conflicts and corrupt your gallery.

3. Portable Mode (The "Thumb Drive" Method)
   The app will build your database and image folders directly next to wherever you placed the application file in Step 1. This is perfect if you placed the app on an external hard drive and want everything kept together.
